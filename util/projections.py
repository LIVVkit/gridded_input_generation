...
def proj_string(proj):
    """
    The proj4 string of a Proj object.

    Pyproj doesn't have a method to return the proj4 string for a Proj object, but does provide a
    method do pickle a proj object, which stores the proj string. This function uses that method to
    extract the proj4 string.
    """
    return proj.__reduce__()[1][0]
