...
def build_base(f_base, f_epsg, d_meters):
    ...
    base.proj.latitude_of_projection_origin = 90.0
    base.proj.straight_vertical_longitude_from_pole = -45.0
    base.proj.standard_parallel = 70.0
    base.proj.proj_scale_factor = 1.0
    base.proj.false_easting = 0.0
    base.proj.false_northing = 0.0
